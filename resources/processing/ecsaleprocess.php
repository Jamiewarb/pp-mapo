...
$PayPalReturnURL = 'http://localhost/mapo/resources/processing/ecsaleprocess.php'; //Point to process.php page
$PayPalCancelURL = 'http://localhost/mapo/ecsale.php?s=cancel'; //Cancel URL if user clicks cancel
