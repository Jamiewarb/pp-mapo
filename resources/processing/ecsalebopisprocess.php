...
$PayPalReturnURL = 'http://localhost/mapo/resources/processing/ecsalebopisprocess.php'; //Point to process.php page
$PayPalCancelURL = 'http://localhost/mapo/ecsalebopis.php?s=cancel'; //Cancel URL if user clicks cancel
...
if ($_POST) {
	...
	$padata = 	'&RETURNURL='.urlencode($PayPalReturnURL).
				...
				'&PAYMENTREQUEST_0_BUCKETCATEGORYTYPE='.urlencode("3").
				'&PAYMENTREQUEST_0_LOCATION_TYPE='.urlencode("2").
				'&PAYMENTREQUEST_0_LOCATION_ID='.urlencode("0000000000000001").
