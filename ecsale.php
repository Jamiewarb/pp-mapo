...
$title = "EC Sale - "; 
$sel = "ecsale"; // This decides which page in the sidebar is selected. Edit the sidebar.php include to check this value for each li
...
<?php include "$sitepath/resources/includes/header.php"; ?>
		<section>
			...
			<div class="content">
				...
				<form method="post" action="resources/processing/ecsaleprocess.php">
					<div class="clear"></div>
